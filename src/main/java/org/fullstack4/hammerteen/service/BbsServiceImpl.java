...
//조회수 체크
    ...
    @Override
    public List<LectureDTO> lectureList(LectureDTO lectureDTO) {
        List<LectureEntity> lecList = lectureRepository.findAll();
        List<LectureDTO> lecTitleList = lecList.stream()
    ...
    @Override
    public PageResponseDTO<BbsDTO> lectureNotice(PageRequestDTO pageRequestDTO, String lectureTitle) {
//        PageRequest pageable = pageRequestDTO.getPageable();
//        Page<BbsEntity> result = null;
//        String category = pageRequestDTO.getCategory1();
//        String category2 = pageRequestDTO.getCategory2();
